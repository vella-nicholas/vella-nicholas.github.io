        ...
        {deliveries.map((card) => (
          ...
          >
            ...
            <dl className="flex flex-col gap-2 text-sm">
              <div>
                <dt className="text-zinc-500 text-xs uppercase tracking-wide mb-0.5">Context</dt>
                <dd className="text-zinc-300">{card.context}</dd>
              </div>
              <div>
                <dt className="text-zinc-500 text-xs uppercase tracking-wide mb-0.5">Role</dt>
                <dd className="text-zinc-300">{card.role}</dd>
              </div>
              <div>
                <dt className="text-zinc-500 text-xs uppercase tracking-wide mb-0.5">Focus</dt>
                <dd className="text-zinc-300">{card.focus}</dd>
              </div>
              <div>
                <dt className="text-zinc-500 text-xs uppercase tracking-wide mb-0.5">Outcome</dt>
